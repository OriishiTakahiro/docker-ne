...
# calculate gprah features
diam                = nx.diameter(graph)
aspl                = nx.average_shortest_path_length(graph)
shortest_paths_ca   = nx.single_source_shortest_path_length(graph, 0)
aspl_ca             = sum(list(shortest_paths_ca.values()))/len(shortest_paths_ca)
...
for image in args.image.split(","):
    ...
    yaml_str = """
# This file is generated by network generator. (https://github.com/OriishiTakahiro/docker-ne)
# graph type: {type}
# N(G)   : {nodes}
# diam(G): {diam}
